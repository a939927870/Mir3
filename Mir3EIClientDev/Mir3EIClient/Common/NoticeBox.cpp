...
#define BTN_POS_X	131	//YDQ
#define BTN_POS_Y	429	//YDQ

#define _IDX_UP_BTN_IMG			1
#define _IDX_ON_BTN_IMG			1251 //YDQ
#define _IDX_DOWN_BTN_IMG		1252 //YDQ
...
HRESULT CNoticeBox::OnButtonDown(POINT tpMouse)		// Button Down
{
	...
	{
		g_xGameProc.m_pSocket->SendNoticeOK();
		hResult = 1;
	}
...
BOOL CNoticeBox::RenderMessageBox(INT nLoopTIme)							// Render Function
{
	...
	{	
		...
		xTxtPos.x = m_rcWnd.left + 55;
		xTxtPos.y = m_rcWnd.top	 + 85;
