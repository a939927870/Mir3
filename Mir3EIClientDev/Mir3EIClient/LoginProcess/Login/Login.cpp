...
{
	INT	nLoop;
	// Buttons							ID							LEFT				TOP						RIGHT	BOTTOM				
	BUTTONINFO LoginProcBtnInfo[] = {
									{ _IMG_IDX_BTN_LOGIN,		_LEFT_LOGIN_BTN,	_TOP_LOGIN_BTN,				30,		15,		BUTTON_STATE_ON}, // Login Button
									{ _IMG_IDX_BTN_NEW,			_LEFT_NEW_BTN,		_TOP_LOGIN_BTNS,			30,		15,		BUTTON_STATE_ON},	// New Account
									{ _IMG_IDX_BTN_CHANGE,		_LEFT_CHANGE_BTN,	_TOP_LOGIN_BTNS,			30,		15,		BUTTON_STATE_ON},	// Change Password
									{ _IMG_IDX_BTN_EXIT,		_LEFT_EXIT_BTN,		_TOP_LOGIN_BTNS,			30,		15,		BUTTON_STATE_ON}	// Exit								
									};
	// EditBox State
	INPUTSTATE LoginInputState[] =  {
									{ LGM_INPUT_ID,				POS_ID_INS_X,		POS_ID_INS_Y,			100,				20,			0,				20,				"\0"},			// Input ID in Login
									{ LGM_INPUT_PASSWORD,		POS_PASS_INS_X,		POS_PASS_INS_Y,			100,				20,			0,				20,				"\0"}			// Input Password In Login
									};
			...
			{	case _IMG_IDX_BTN_LOGIN:
				...
				//	m_fShowIDPASS = !m_fShowIDPASS;
					if(m_nUserState == LGM_INPUT_PASSWORD)
						GetWindowText(g_xChatEditBox.GetSafehWnd(),m_xInputState[m_nUserState-1].szData ,m_xInputState[m_nUserState-1].nSize);
